...
fn static_catalog_key(text: &str) -> Option<&'static str> {
    match text {
        ...
        "Modifiers hidden while the replacement is active" => Some("key_picker_text.modifiers_hidden_while_the_replacement_is_active"),
        "Modifiers required for this override" => Some("key_picker_text.modifiers_required_for_this_override"),
        "Modifiers that block this override" => Some("key_picker_text.modifiers_that_block_this_override"),
        "Layers where this override can activate" => Some("key_picker_text.layers_where_this_override_can_activate"),
        ...
        "Custom keycodes — defined by this keyboard" => Some("key_picker_text.custom_keycodes_defined_by_this_keyboard"),
        ...
        "No Tap Dance slots available on this keyboard" => Some("tap_dance_editor.no_tap_dance_slots_available_on_this_keyboard"),
        ...
        "Tapping Term" => Some("macro_editor.tapping_term"),
        ...
        "Tapping term is in milliseconds" => Some("macro_editor.tapping_term_is_in_milliseconds"),
        "Clear all actions for this tap dance" => Some("key_picker_text.clear_all_actions_for_this_tap_dance"),
        "Undo last tap dance change" => Some("tap_dance_editor.undo_last_tap_dance_change"),
        "Tap Dance Editor" => Some("key_picker_text.tap_dance_editor"),
        "Keyboard is locked, unlock it to use Matrix Tester" => Some("matrix_tester.keyboard_is_locked_unlock_it_to_use_matrix_tester"),
        "Click to reset Matrix Tester" => Some("matrix_tester.click_to_reset_matrix_tester"),
        "Matrix Tester is currently available only for Vial keyboards" => Some("matrix_tester.matrix_tester_is_currently_available_only_for_vial_keyboards"),
        "Connect a Vial keyboard to start live switch testing" => Some("matrix_tester.connect_a_vial_keyboard_to_start_live_switch_testing"),
        ...
        "Connect a Vial keyboard to edit Auto Shift settings" => Some("auto_shift_settings.connect_a_vial_keyboard_to_edit_auto_shift_settings"),
        ...
        "Macros saved" => Some("key_picker_text.macros_saved"),
        ...
        "↶ Undo" => Some("key_picker_text.undo_undo_6840d526"),
        ...
        "Enable N-key rollover" => Some("auto_shift_settings.enable_n_key_rollover"),
        ...
        "Tapping term" => Some("macro_editor.tapping_term_cbc17e7a"),
        ...
        "Tap-then-hold repeat window for dual-role key tap actions" => Some("macro_editor.tap_then_hold_repeat_window_for_dual_role_key_tap_actions"),
        "Tap code delay" => Some("macro_editor.tap_code_delay"),
        "Delay between register and unregister in tap_code" => Some("macro_editor.delay_between_register_and_unregister_in_tap_code"),
        "Tap hold caps delay" => Some("macro_editor.tap_hold_caps_delay"),
        ...
        "Tapping toggle" => Some("macro_editor.tapping_toggle"),
        ...
        "Tap this many times to keep a one-shot key held until tapped again" => Some("macro_editor.tap_this_many_times_to_keep_a_one_shot_key_held_until_tapped_again"),
        ...
        "Text sens" => Some("macro_editor.text_sens"),
        "Text mode divisor: lower is faster, higher is slower" => Some("macro_editor.text_mode_divisor_lower_is_faster_higher_is_slower"),
...
Alt"# => Some("key_names.right_alt"),
        ...
        "Escape — cancel / close" => Some("key_names.escape_cancel_close"),
        "Backspace — delete character before cursor" => Some("key_names.backspace_delete_character_before_cursor"),
        "Tab — indent / move focus forward" => Some("keycode_tooltips.tab_indent_move_focus_forward"),
        "Caps Lock — toggle uppercase input" => Some("key_names.caps_lock_toggle_uppercase_input"),
        "Menu key — open right-click context menu" => Some("key_names.menu_key_open_right_click_context_menu"),
        ...
        "Home — jump to beginning of line" => Some("key_names.home_jump_to_beginning_of_line"),
        "End — jump to end of line" => Some("key_names.end_jump_to_end_of_line"),
        "Page Up — scroll up one page" => Some("key_names.page_up_scroll_up_one_page"),
        "Page Down — scroll down one page" => Some("key_names.page_down_scroll_down_one_page"),
        "Insert — toggle insert/overwrite mode" => Some("key_names.insert_toggle_insert_overwrite_mode"),
        "Delete — delete character after cursor" => Some("key_names.delete_delete_character_after_cursor"),
        "Print Screen — take a screenshot" => Some("key_names.print_screen_take_a_screenshot"),
        "Pause / Break" => Some("key_names.pause_break"),
...
Toggle"# => Some("keycode_tooltips.combo_toggle"),
        ...
        "Bootloader — put keyboard into flash mode" => Some("keycode_tooltips.bootloader_put_keyboard_into_flash_mode"),
...
Stop"# => Some("keycode_tooltips.stop_stop"),
        r#"🎵
Media"# => Some("status_text.media_media"),
        r#"✉
...
Pad"# => Some("keycode_tooltips.launch_pad"),
        ...
        "Volume Up" => Some("status_text.volume_up"),
        "Volume Down" => Some("status_text.volume_down"),
...
App"# => Some("key_names.next_app"),
        ...
        "Left Control when held, ( when tapped" => Some("key_names.left_control_when_held_when_tapped"),
        "Right Control when held, ) when tapped" => Some("key_names.right_control_when_held_when_tapped"),
        "Left Shift when held, ( when tapped" => Some("key_names.left_shift_when_held_when_tapped"),
        "Right Shift when held, ) when tapped" => Some("key_names.right_shift_when_held_when_tapped"),
        "Left Alt when held, ( when tapped" => Some("key_names.left_alt_when_held_when_tapped"),
        "Right Alt when held, ) when tapped" => Some("key_names.right_alt_when_held_when_tapped"),
        "Right Shift when held, Enter when tapped" => Some("key_names.right_shift_when_held_enter_when_tapped"),
        "Left Ctrl — modifier key (hold to activate shortcuts)" => Some("key_names.left_ctrl_modifier_key_hold_to_activate_shortcuts"),
        "Right Ctrl — modifier key (hold to activate shortcuts)" => Some("key_names.right_ctrl_modifier_key_hold_to_activate_shortcuts"),
        "Left Shift — hold to type uppercase / shifted symbols" => Some("key_names.left_shift_hold_to_type_uppercase_shifted_symbols"),
        "Right Shift — hold to type uppercase / shifted symbols" => Some("key_names.right_shift_hold_to_type_uppercase_shifted_symbols"),
        "Left Alt — modifier key (hold to activate shortcuts)" => Some("key_names.left_alt_modifier_key_hold_to_activate_shortcuts"),
        "Right Alt / AltGr — access special characters" => Some("key_names.right_alt_altgr_access_special_characters"),
        ...
        "Left Control" => Some("key_names.left_control"),
        "Right Control" => Some("key_names.right_control"),
        "Left Shift" => Some("key_names.left_shift_494064e7"),
        "Right Shift" => Some("key_names.right_shift_26a36a6d"),
        "Left Alt" => Some("key_names.left_alt_c689a8e4"),
        "Right Alt" => Some("key_names.right_alt_cdd21f78"),
        "Swap Caps Lock and Left Control" => Some("key_names.swap_caps_lock_and_left_control"),
        "Unswap Caps Lock and Left Control" => Some("keycode_tooltips.unswap_caps_lock_and_left_control"),
        "Toggle Caps Lock and Left Control swap" => Some("key_names.toggle_caps_lock_and_left_control_swap"),
        ...
        "Swap ` and Escape" => Some("key_names.swap_grave_and_escape"),
        "Unswap ` and Escape" => Some("keycode_tooltips.unswap_grave_and_escape"),
        r#"Swap \ and Backspace"# => Some("key_names.swap_backslash_and_backspace"),
        r#"Unswap \ and Backspace"# => Some("keycode_tooltips.unswap_backslash_and_backspace"),
        r#"Toggle \ and Backspace swap state"# => Some("key_names.toggle_backslash_and_backspace_swap_state"),
        ...
        "Toggle N-key rollover" => Some("key_names.toggle_n_key_rollover"),
        ...
        "Swap Caps Lock and Escape" => Some("key_names.swap_caps_lock_and_escape"),
        "Unswap Caps Lock and Escape" => Some("keycode_tooltips.unswap_caps_lock_and_escape"),
        "Toggle Caps Lock and Escape swap" => Some("key_names.toggle_caps_lock_and_escape_swap"),
        _ => None,
    }
}
