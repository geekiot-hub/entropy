...
pub const KEYCODES: &[Keycode] = &[
    ...
    // ── Control keys ─────────────────────────────────────────────────────────
    Keycode { value: 0x0028, name: "KC_ENT",   label: "Enter", category: KeycodeCategory::Basic },
    Keycode { value: 0x0029, name: "KC_ESC",   label: "Esc",   category: KeycodeCategory::Basic },
    Keycode { value: 0x002A, name: "KC_BSPC",  label: "BkSp",  category: KeycodeCategory::Basic },
    ...
    Keycode { value: 0x0065, name: "KC_APP",   label: "Menu",  category: KeycodeCategory::Basic },

    // ── Punctuation & symbols ────────────────────────────────────────────────
    // These are the unshifted values; Shift+key gives the shifted symbol
    Keycode { value: 0x002D, name: "KC_MINS",  label: "-_",   category: KeycodeCategory::Basic },
    ...
    Keycode { value: 0x0032, name: "KC_NUHS",  label: "#~",   category: KeycodeCategory::Basic },
    ...
    Keycode { value: 0x0064, name: "KC_NUBS",  label: "\\|",  category: KeycodeCategory::Basic },
    ...
    Keycode { value: 0x004F, name: "KC_RGHT",  label: "Right",  category: KeycodeCategory::Navigation },
    ...
    Keycode { value: 0x0058, name: "KC_PENT",  label: "NEntr",category: KeycodeCategory::Numpad },
    ...
    Keycode { value: 0x0085, name: "KC_PCMM",  label: "N,",   category: KeycodeCategory::Numpad },
    ...
    Keycode { value: 0x5106, name: "MO(6)",   label: "MO(6)",  category: KeycodeCategory::Layer },
    Keycode { value: 0x5107, name: "MO(7)",   label: "MO(7)",  category: KeycodeCategory::Layer },
    ...
    Keycode { value: 0x5306, name: "TG(6)",   label: "TG(6)",  category: KeycodeCategory::Layer },
    Keycode { value: 0x5307, name: "TG(7)",   label: "TG(7)",  category: KeycodeCategory::Layer },
    Keycode { value: 0x5200, name: "DF(0)",   label: "DF(0)",  category: KeycodeCategory::Layer },
    Keycode { value: 0x5201, name: "DF(1)",   label: "DF(1)",  category: KeycodeCategory::Layer },
    Keycode { value: 0x5202, name: "DF(2)",   label: "DF(2)",  category: KeycodeCategory::Layer },
    Keycode { value: 0x5203, name: "DF(3)",   label: "DF(3)",  category: KeycodeCategory::Layer },
    ...
    Keycode { value: 0x5404, name: "OSL(4)",  label: "OSL(4)", category: KeycodeCategory::Layer },

    // ── One-shot modifiers ───────────────────────────────────────────────────
    Keycode { value: 0x5501, name: "OSM(LSFT)", label: "OSM\nLSft", category: KeycodeCategory::Modifier },
    Keycode { value: 0x5502, name: "OSM(LCTL)", label: "OSM\nLCtl", category: KeycodeCategory::Modifier },
    Keycode { value: 0x5504, name: "OSM(LALT)", label: "OSM\nLAlt", category: KeycodeCategory::Modifier },
    Keycode { value: 0x5508, name: "OSM(LGUI)", label: "OSM\nLGui", category: KeycodeCategory::Modifier },
    Keycode { value: 0x5511, name: "OSM(RSFT)", label: "OSM\nRSft", category: KeycodeCategory::Modifier },
    Keycode { value: 0x5512, name: "OSM(RCTL)", label: "OSM\nRCtl", category: KeycodeCategory::Modifier },
    Keycode { value: 0x5514, name: "OSM(RALT)", label: "OSM\nRAlt", category: KeycodeCategory::Modifier },
    Keycode { value: 0x5518, name: "OSM(RGUI)", label: "OSM\nRGui", category: KeycodeCategory::Modifier },
...
pub fn keycode_label(value: u16) -> String {
    ...
    // LT(layer, kc): 0x4nkk where n=layer, kk=basic keycode
    ...
    // MT(mod, kc): 0x2mkk where m=mod mask, kk=basic keycode
