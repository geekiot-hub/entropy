...
pub const KEYCODES: &[Keycode] = &[
    ...
    // ── Media ────────────────────────────────────────────────────────────────
    Keycode { value: 0x00CD, name: "KC_MPLY",    label: "⏯",     category: KeycodeCategory::Media },
    Keycode { value: 0x00B5, name: "KC_MNXT",    label: "⏭",     category: KeycodeCategory::Media },
    Keycode { value: 0x00B6, name: "KC_MPRV",    label: "⏮",     category: KeycodeCategory::Media },
    Keycode { value: 0x00B7, name: "KC_MSTP",    label: "⏹",     category: KeycodeCategory::Media },
    Keycode { value: 0x00E9, name: "KC_VOLU",    label: "Vol+",   category: KeycodeCategory::Media },
    Keycode { value: 0x00EA, name: "KC_VOLD",    label: "Vol-",   category: KeycodeCategory::Media },
    Keycode { value: 0x00E2, name: "KC_MUTE",    label: "Mute",   category: KeycodeCategory::Media },
    Keycode { value: 0x0192, name: "KC_MSEL",    label: "MSel",   category: KeycodeCategory::Media },
    Keycode { value: 0x018A, name: "KC_MAIL",    label: "Mail",   category: KeycodeCategory::Media },
    Keycode { value: 0x0223, name: "KC_WHOM",    label: "WWW",    category: KeycodeCategory::Media },
    Keycode { value: 0x0224, name: "KC_WBAK",    label: "Back",   category: KeycodeCategory::Media },
    Keycode { value: 0x0225, name: "KC_WFWD",    label: "Fwd",    category: KeycodeCategory::Media },
    Keycode { value: 0x0226, name: "KC_WSTP",    label: "Stop",   category: KeycodeCategory::Media },
    Keycode { value: 0x0227, name: "KC_WREF",    label: "Rfsh",   category: KeycodeCategory::Media },
    Keycode { value: 0x0221, name: "KC_WSCH",    label: "Srch",   category: KeycodeCategory::Media },
