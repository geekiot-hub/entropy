...
\\", category: KeycodeCategory::Basic },
    ...
    // ── Mouse ─────────────────────────────────────────────────────────────────
    Keycode { value: 0x00CD, name: "KC_MS_U",     label: "🖱⬆",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00CE, name: "KC_MS_D",     label: "🖱⬇",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00CF, name: "KC_MS_L",     label: "🖱⬅",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00D0, name: "KC_MS_R",     label: "🖱➡",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00D1, name: "KC_BTN1",     label: "🖱L",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00D2, name: "KC_BTN2",     label: "🖱R",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00D3, name: "KC_BTN3",     label: "🖱M",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00D4, name: "KC_BTN4",     label: "🖱4",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00D5, name: "KC_BTN5",     label: "🖱5",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00D6, name: "KC_BTN6",     label: "🖱6",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00D7, name: "KC_BTN7",     label: "🖱7",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00D8, name: "KC_BTN8",     label: "🖱8",   category: KeycodeCategory::Mouse },
    Keycode { value: 0x00D9, name: "KC_WH_U",     label: "⬆ Scrl", category: KeycodeCategory::Mouse },
    Keycode { value: 0x00DA, name: "KC_WH_D",     label: "⬇ Scrl", category: KeycodeCategory::Mouse },
    Keycode { value: 0x00DB, name: "KC_WH_L",     label: "⬅ Scrl", category: KeycodeCategory::Mouse },
    Keycode { value: 0x00DC, name: "KC_WH_R",     label: "➡ Scrl", category: KeycodeCategory::Mouse },
    Keycode { value: 0x00DD, name: "KC_MS_ACCEL0", label: "🖱A0",  category: KeycodeCategory::Mouse },
    Keycode { value: 0x00DE, name: "KC_MS_ACCEL1", label: "🖱A1",  category: KeycodeCategory::Mouse },
    Keycode { value: 0x00DF, name: "KC_MS_ACCEL2", label: "🖱A2",  category: KeycodeCategory::Mouse },
