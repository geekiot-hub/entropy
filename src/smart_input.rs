...
#[path = "smart_input_text_expander.rs"]
mod smart_input_text_expander;
use smart_input_text_expander::{
    current_process_name_lower, remember_current_foreground_app, remember_foreground_app,
    text_expander_enabled, text_expander_engine, text_expander_suppressed_for_context,
};
pub use smart_input_text_expander::{
    set_text_expander_config, text_expander_app_candidates, TextExpanderAppCandidate,
};
